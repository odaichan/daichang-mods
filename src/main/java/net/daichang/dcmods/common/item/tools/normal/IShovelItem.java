...
public class IShovelItem extends ShovelItem {
    public IShovelItem(Tier pTier, float pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
