...
public class IPickaxeItem extends PickaxeItem {
    public IPickaxeItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
