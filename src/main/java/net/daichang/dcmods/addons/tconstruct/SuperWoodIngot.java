...
public class SuperWoodIngot extends Modifier implements ModifyDamageSourceModifierHook, TooltipModifierHook, ToolActionModifierHook {
    @Override
    protected void registerHooks(ModuleHookMap.@NotNull Builder hookBuilder) {
        hookBuilder.addHook(this, EtSTLibHooks.MODIFY_DAMAGE_SOURCE, ModifierHooks.TOOLTIP, ModifierHooks.TOOL_ACTION);
    }
