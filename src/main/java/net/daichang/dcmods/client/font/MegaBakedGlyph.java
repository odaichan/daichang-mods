...
import com.mega.uom.mixin.time.EmptyGlyphAccessor;
...
public class MegaBakedGlyph extends BakedGlyph {
    ...
    public MegaBakedGlyph(GlyphRenderTypes p_285527_, float p_285271_, float p_284970_, float p_285098_, float p_285023_, float p_285242_, float p_285043_, float p_285100_, float p_284948_) {
    ...
    public static MegaBakedGlyph createByEmpty(net.minecraft.client.gui.font.glyphs.BakedGlyph glyph) {
        EmptyGlyphAccessor accessor = (EmptyGlyphAccessor) glyph;
        return new MegaBakedGlyph(accessor.renderTypes(), accessor.u0(), accessor.u1(), accessor.v0(), accessor.v1(), accessor.left(), accessor.right(), accessor.up(), accessor.down());
    }
    ...
    public void renderEffect(MegaBakedGlyph.Effect p_95221_, Matrix4f p_254370_, VertexConsumer p_95223_, int p_95224_) {
