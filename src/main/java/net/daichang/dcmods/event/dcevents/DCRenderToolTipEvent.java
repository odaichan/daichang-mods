...
public class DCRenderToolTipEvent extends Event {
    ...
    @ApiStatus.Internal
    protected DCRenderToolTipEvent(@NotNull ItemStack itemStack, GuiGraphics graphics, int x, int y, @NotNull Font font, @NotNull List<ClientTooltipComponent> components) {
